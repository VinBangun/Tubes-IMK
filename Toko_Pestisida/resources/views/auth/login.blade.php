          ...
          <div class="row flex-grow">
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                ...
                <h4>Hai!</h4>
                <h6 class="font-weight-light">Silahkan Login Untuk Dapat Berbelanja</h6>
                <form class="pt-3" method="POST" action="{{ route('login') }}">
                  ...
                  <div class="mt-3">
                    <button class="btn btn-block btn-gradient-danger btn-lg font-weight-medium auth-form-btn" type="submit">MASUK</button>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Belum Memiliki Akun? <a href="/register" class="text-danger">Daftar</a>
                  </div>
                </form>
              </div>
            </div>
