...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('adminassets') }}/assets/images/Eleventry.jpg" />
  </head>
  <body>
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                 <center><img src="{{ asset('adminassets') }}/assets/images/login.jpg"></center>
                </div>
                <h4>Silahkan Daftar Terlebih dahulu</h4>
                <h6 class="font-weight-light">Daftarkan Akun Kamu Agar Dapat Melakukan Pemesanan</h6>
                  ...
                  <div class="mb-4">
                    <div class="form-check">
                      <label class="form-check-label text-muted">
                        <input type="checkbox" class="form-check-input">Setuju Dengan Syarat Dan Ketentuan</label>
                    </div>
                  </div>
                  <div class="mt-3">
                    <button type="submit" class="btn btn-block btn-gradient-danger btn-lg font-weight-medium auth-form-btn">Daftar</button>
                  </div>
                  <div class="text-center mt-4 font-weight-light"> Sudah Memiliki Akun? <a href="{{ route('login') }}" class="text-danger">Masuk</a>
                  </div>
                </form>
              </div>
            </div>
