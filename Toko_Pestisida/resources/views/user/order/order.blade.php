...
<div class="site-section">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-dark text-white">Belum Dibayar</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-dark text-white">Sedang Dalam Proses</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-dark text-white">Riwayat Pesanan Anda</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $o->invoice }}</td>
                    <td>{{ $o->subtotal + $o->biaya_transfer }}</td>
                    <td>{{ $o->name }}</td>
                    <td>
                    <a href="{{ route('user.order.detail',['id' => $o->id]) }}" class="btn btn-success">Detail</a>
                    </td>
