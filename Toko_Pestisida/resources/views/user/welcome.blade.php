...
<div class="site-blocks-cover" style="background-image: url({{asset('shopper')}}/images/hero_1.jpg);" data-aos="fade">
    ...
    <div class="row align-items-start align-items-md-center justify-content-end">
        ...
        <h1 class="mb-2">Cari Pestisida Yang Kamu Inginkan Disini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Semua Produk Pestisida Dijamin Original Dengan Kualitas Terbaik</p>
            <p>
            <a href="{{ route('user.produk') }}" class="btn btn-sm btn-dark">Belanja</a>
            </p>
        </div>
        </div>
    </div>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="icon mr-4 align-self-start">
            <span class="icon-truck" style="color:coral";></span>
        </div>
        <div class="text">
        ...
        <div class="icon mr-4 align-self-start">
            <span class="icon-star"style="color:coral";></span>
        </div>
        <div class="text">
        ...
        <div class="icon mr-4 align-self-start">
            <span class="icon-security"style="color:coral";></span>
        </div>
        <div class="text">
    ...
    <div class="row">
        ...
        <div class="nonloop-block-3 owl-carousel" >
            ...
            <div class="block-4 text-center">
                ...
                <h3><a href="{{ route('user.produk.detail',['id' =>  $produk->id]) }}"style="color:coral;">{{ $produk->name }}</a></h3>
